...
function Home1() {
  ...
  return (
    <>
      <Preloader />
      <div className="flex flex-col p-8 lg:flex-row justify-between bg-gray-50 border-b-2 border-black mb-4">
        <div className="w-full lg:w-1/2 flex flex-col justify-center lg:ml-40 p-4 lg:p-0">
          <div className="w-80 mb-8 mx-auto lg:mx-0">
            <img
              className="me-photo rounded-2xl shadow-2xl"
              src={alpha4}
              alt=""
            />
          </div>
          ...
          <p className="text-2xl lg:text-3xl font-semibold text-center lg:text-left m-1">
            Full Stack <span className="text-yellow-500">JavaScript</span>{" "}
            Developer
          </p>
        </div>
        <div
         className="w-full lg:w-1/2 flex flex-col space-y-10 mb-10 p-4 lg:p-0">
          <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-10">
            <div className="w-full lg:w-56 mx-auto lg:mx-0">
              <img
                className="hidden lg:block rounded-2xl shadow-2xl"
                src={alpha1}
                alt=""
              />
            </div>
      ...
      <div className="flex flex-col bg-yellow-400 mb-10 lg:flex-row justify-center">
        ...
        <div  
          ...
          className="w-full lg:w-1/2 text-xl sm:text-2xl lg:text-5xl font-semibold flex flex-col justify-center mb-20 sm:mb-40 lg:mb-60 ml-6 sm:ml-10 lg:ml-20 mt-10 lg:mt-40">
          <img className="w-48 ml-20 sm:w-56 lg:w-64" src={ele1} alt="" />
          <h1 className="text-center font-semibold ml-4 mr-8 lg:text-left">KNOW ABOUT ME</h1>
          <div className="flex items-center mt-4 ">
            <span className="rounded-full ml-32 px-4  sm:px-6 inline-block border-zinc-900 capitalize py-1 text-lg sm:text-2xl border">
              <a href="#">Click Here</a>
            </span>
          </div>
        </div>
